...
<body class="login-page">
    <div class="login-box">
        <div class="logo">
            <a href="javascript:void(0);">PPW CRM - Account</a>
        </div>
        <div class="card">
            <div class="body">
    ...
    <!-- Jquery Core Js -->
    <script src="{!! generate_asset_url('plugins/jquery/jquery.min.js') !!}"></script>

    <!-- Bootstrap Core Js -->
    <script src="{!! generate_asset_url('plugins/bootstrap/js/bootstrap.js') !!}"></script>

    <!-- Waves Effect Plugin Js -->
    <script src="{!! generate_asset_url('plugins/node-waves/waves.js') !!}"></script>

    <!-- Validation Plugin Js -->
    <script src="{!! generate_asset_url('plugins/jquery-validation/jquery.validate.js') !!}"></script>

    <!-- Custom Js -->
    <script src="{!! generate_asset_url('js/admin.js') !!}"></script>
    <script src="{!! generate_asset_url('js/pages/examples/sign-in.js') !!}"></script>
</body>
