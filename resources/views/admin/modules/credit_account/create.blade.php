            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header clearfix">
                        <h2 class="pull-left">
                            <i class="material-icons btn btn-sm btn-warning">create</i> <span> &nbsp; Create New Credit Account</span>
                        </h2>
                        <a href="{!! URL::to('module/credit_account') !!}" class="pull-right">Back to List</a>
                    </div>
                    <div class="body">
                        {!! Form::open(['url' => url('module/credit_account'), 'class' => 'form']) !!}
                        <div class="row clearfix">
                            <div class="col-xs-12">
                            ...
                            <div class="col-xs-12">
                                <label for="">Credit Account NO</label>
                                <div class="input-group">
                                    <span class="input-group-addon">
                                        <i class="material-icons">edit</i>
                                    </span>
